<template>
  <article class="catalog-card radius nightGlowArticle white--text pa-2 mb-3">
      ...
      <div class="catalog-card__wrapper">
        ...
        <div class="catalog-card__info mt-1 mb-2">
          <div class="catalog-card__info-container">
            <v-btn
              class="catalog-card__title white--text text-none pa-0"
              width="auto"
              height="auto"
              text
            >
              <v-icon class="white--text mr-1">mdi-home</v-icon>
              Название объявления
            </v-btn>

            <div class="catalog-card__address">
              <v-icon class="white--text mx-1" small>mdi-map-marker</v-icon>
